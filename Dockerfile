FROM debian:buster
MAINTAINER Brandon Premo <brandon.premo@gmail.com>
...
RUN apt-get -qqy update \
	...
	&& apt-get -qqy install ca-certificates curl python-gpg dropbox \
    # install a bunch of dependencies
    && apt-get -qqy install libc6 libglapi-mesa libxdamage1 libxfixes3 libxcb-glx0 \
    libxcb-dri2-0 libxcb-dri3-0 libxcb-present0 libxcb-sync1 libxshmfence1 \
